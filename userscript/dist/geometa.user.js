...
// @connect      kacuunztbvznzhfsyfgp.supabase.co
// @grant        GM_addStyle
// @grant        GM_getValue
// @grant        GM_info
...
(async function () {
  ...
  var root_2 = /* @__PURE__ */ from_html(`<div class="announcement svelte-xwh0kw"><div class="svelte-xwh0kw"><!></div> <button class="vote-close-btn svelte-xwh0kw" aria-label="Dismiss announcement">Dismiss</button></div>`);
  var root_3 = /* @__PURE__ */ from_html(`<p class="svelte-xwh0kw"> </p>`);
  var root_6 = /* @__PURE__ */ from_html(`<p class="geometa-footer svelte-xwh0kw"><!></p>`);
  var root_7 = /* @__PURE__ */ from_html(`<hr class="svelte-xwh0kw"/> <!>`, 1);
  var root_5 = /* @__PURE__ */ from_html(`<p class="svelte-xwh0kw"><!> <strong class="svelte-xwh0kw"> </strong> </p> <div class="geometa-note svelte-xwh0kw"><!></div> <!> <!>`, 1);
  var root_9 = /* @__PURE__ */ from_html(`<div class="modal-backdrop svelte-xwh0kw"><div class="modal svelte-xwh0kw"><p class="svelte-xwh0kw">You are about to open this site in a new tab:</p> <p class="modal-url svelte-xwh0kw"> </p> <div class="modal-buttons svelte-xwh0kw"><button class="proceed-btn svelte-xwh0kw">Continue</button> <button class="close-btn svelte-xwh0kw">Cancel</button></div></div></div>`);
  var root_11 = /* @__PURE__ */ from_html(`<p class="outdated svelte-xwh0kw"><strong class="svelte-xwh0kw"> </strong></p>`);
  var root_10 = /* @__PURE__ */ from_html(`<div class="modal-backdrop svelte-xwh0kw"><div class="modal svelte-xwh0kw"><div class="help-message svelte-xwh0kw"><!> <p class="svelte-xwh0kw">Welcome to LearnableMeta, we hope you are enjoying it, some quick info:</p> <ul class="svelte-xwh0kw"><li class="svelte-xwh0kw"><strong class="svelte-xwh0kw">Drag to Move:</strong> Click and drag the top of the note to reposition it anywhere on your
              screen.</li> <li class="svelte-xwh0kw"><strong class="svelte-xwh0kw">Resize:</strong> Use the bottom-right corner to resize the note to your liking.</li> <li class="svelte-xwh0kw"><strong class="svelte-xwh0kw">View Map meta list:</strong> Click the list icon to see all the metas included in the map you
              are currently playing.</li> <li class="svelte-xwh0kw"><strong class="svelte-xwh0kw">Join the Community:</strong> Click the Discord icon to share feedback, suggest improvements, or
              just say hi!</li> <li class="svelte-xwh0kw"><strong class="svelte-xwh0kw">Outdated Script:</strong> The question mark icon will blink if the script is outdated.</li></ul></div> <button class="close-btn svelte-xwh0kw">Close</button></div></div>`);
  var root$4 = /* @__PURE__ */ from_html(`<div class="geometa-version svelte-xwh0kw"> </div> <div class="geometa-container svelte-xwh0kw"><!> <div class="flex header svelte-xwh0kw"><h2 class="svelte-xwh0kw">Learnable Meta</h2> <div class="icons svelte-xwh0kw"><a target="_blank" aria-label="List of map metas" class="svelte-xwh0kw"><span class="skill-icons--list svelte-xwh0kw"></span></a> <a href="https://learnablemeta.com/" target="_blank" aria-label="Learnable Meta website" class="svelte-xwh0kw"><span class="flat-color-icons--globe svelte-xwh0kw"></span></a> <a href="https://discord.gg/AcXEWznYZe" target="_blank" aria-label="Learnable Meta discord" class="svelte-xwh0kw"><span class="skill-icons--discord svelte-xwh0kw"></span></a> <button aria-label="More information" style="background: none; border: none; padding: 0;" class="svelte-xwh0kw"><span></span></button></div></div> <!> <!> <!></div>`, 1);
  function App($$anchor, $$props) {
    push($$props, true);
    const scriptVersion = _GM_info.script.version;
    ...
    bind_this(div_4, ($$value) => header = $$value, () => header);
    var node_3 = sibling(div_4, 2);
    {
      var consequent_1 = ($$anchor2) => {
        var p = root_3();
        var text_1 = child(p);
        template_effect(() => set_text(text_1, `Error: ${get(error) ?? ""}`));
        append($$anchor2, p);
      };
          ...
          var consequent_4 = ($$anchor3) => {
            ...
            var node_9 = sibling(node_7, 2);
            {
              var consequent_3 = ($$anchor4) => {
                ...
                var node_10 = sibling(first_child(fragment_4), 2);
                Carousel(node_10, {
                  get images() {
            ...
            template_effect(() => {
              set_text(text_2, get(geoInfo).country);
              set_text(text_3, ` - ${get(geoInfo).metaName ?? ""}`);
            });
      ...
      var consequent_7 = ($$anchor2) => {
        ...
        var node_13 = child(div_12);
        {
          var consequent_6 = ($$anchor3) => {
            ...
            template_effect(
              ($0) => set_text(text_5, `Your script version is out of date - please install the latest
              version (${$0 ?? ""})!`),
    ...
    template_effect(() => {
      set_text(text, `v${scriptVersion ?? ""}`);
      set_attribute(a, "href", "https://learnablemeta.com/maps/" + $$props.mapId);
      set_class(span, 1, clsx(get(helpClass)), "svelte-xwh0kw");
    });
    append($$anchor, fragment);
    pop();
  }
  ...
  function HintPanel($$anchor, $$props) {
    ...
    let inSupabase = /* @__PURE__ */ mutable_source(false);
    const metaTypes = [
      "bollard",
      "car",
      "sign",
    ...
    function detectImage() {
      ...
      image_url = (img == null ? void 0 : img.getAttribute("src")) || "";
      checkSupabase();
    }
